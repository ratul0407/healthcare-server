-- CreateEnum
CREATE TYPE "BloodGroup" AS ENUM ('A_Postive', 'A_Negative', 'B_Positive', 'B_Negative', 'AB_Positive', 'AB_Negative', 'O_Positive', 'O_Negative');

-- CreateEnum
CREATE TYPE "MartialStatus" AS ENUM ('MARRIED', 'UNMARRIED');

-- AlterTable
ALTER TABLE "doctors" ADD COLUMN     "averageRating" DOUBLE PRECISION NOT NULL DEFAULT 0;
...
CREATE TABLE "patient_health_datas" (
    ...
    "maritalStatus" "MartialStatus" NOT NULL DEFAULT 'UNMARRIED',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
